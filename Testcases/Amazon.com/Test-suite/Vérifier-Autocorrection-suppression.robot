...
vérifie la Fonctionalité
    #Login.field blank
    Static-amazonRecherche.Saisie-de-text-a-Barre-de-recherche    msi gl66 gamung laptp
    Static-amazonRecherche.Click-sur-button-de-barre-recherche
    Dynamic-Resultatsection.Click-Sur-autoCorrection
    ...
    Static-Lapage-produit.DeleteItems
