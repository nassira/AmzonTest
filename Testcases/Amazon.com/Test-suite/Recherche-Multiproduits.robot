...
vérifie la Fonctionalité
    Saisie-de-text-a-Barre-de-recherche    msi gl66 gaming laptop
    ...
    Static-amazonRecherche.Saisie-de-text-a-Barre-de-recherche    HP 2021 Stream 14in HD Display
    Static-amazonRecherche.Click-sur-button-de-barre-recherche
    Dynamic-Resultatsection.Click-Sur-image-DelaDeuxiéme-imageRecherché
    Go Back
    Dynamic-Resultatsection.Click-Sur-Lien-DelaDeuxiéme-imageRecherché
    Static-Lapage-produit.le-Choix-de-quantité
    Dynamic-Lapage-produit.Ajouté-à-laCarte
